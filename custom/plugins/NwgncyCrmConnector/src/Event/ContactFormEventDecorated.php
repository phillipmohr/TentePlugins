...
class ContactFormEventDecorated extends Event implements SalesChannelAware, MailAware, ContactFormDataAware, ScalarValuesAware, FlowEventAware
{
     public const EVENT_NAME = 'tente.contact_form.send';
    /**
